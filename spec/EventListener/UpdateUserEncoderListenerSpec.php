...
use Owl\Bundle\UserBundle\spec\Fixture\FixtureUser;
use Owl\Bundle\UserBundle\spec\Fixture\FixtureUserInterface;
...
final class UpdateUserEncoderListenerSpec extends ObjectBehavior
{
    ...
    public function it_does_nothing_if_user_does_not_implement_user_interface(
    ...
    public function it_does_nothing_if_user_does_not_implement_specified_class_or_interface(
        ObjectManager $objectManager,
        Request $request,
        TokenInterface $token,
        User $user,
    ...
    public function it_does_nothing_if_user_uses_the_recommended_encoder(
        ObjectManager $objectManager,
        Request $request,
        TokenInterface $token,
        FixtureUser $user,
    ...
    public function it_does_nothing_if_plain_password_could_not_be_resolved(
        ObjectManager $objectManager,
        TokenInterface $token,
        FixtureUser $user,
    ): void {
    ...
    public function it_does_nothing_if_resolved_plain_password_is_null(
        ObjectManager $objectManager,
        TokenInterface $token,
        FixtureUser $user,
    ): void {
    ...
    public function it_does_nothing_if_resolved_plain_password_is_empty(
        ObjectManager $objectManager,
        TokenInterface $token,
        FixtureUser $user,
    ): void {
    ...
    public function it_updates_the_encoder_and_plain_password_if_using_old_encoder_and_plain_password_could_be_resolved(
        ObjectManager $objectManager,
        TokenInterface $token,
        FixtureUser $user,
    ): void {
    ...
    public function it_updates_the_encoder_and_plain_password_if_using_default_null_encoder_and_plain_password_could_be_resolved(
        ObjectManager $objectManager,
        TokenInterface $token,
        FixtureUser $user,
    ): void {
