...
final class UserLastLoginSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith($userManager, 'Owl\Component\User\Model\UserInterface');
    }
    ...
    public function it_throws_exception_if_subscriber_is_used_for_class_other_than_sylius_user_interface(
        ObjectManager $userManager,
        Request $request,
        TokenInterface $token,
        SymfonyUserInterface $user,
