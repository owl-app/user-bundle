...
final class SyliusUserExtensionTest extends AbstractExtensionTestCase
{
    ...
    public function it_decorates_user_factory_if_its_configuration_has_encoder_specified(): void
    {
        ...
        Assert::assertSame(UserWithHasherFactory::class, $factoryDefinition->getClass());
    ...
    public function it_creates_a_update_user_encoder_listener_for_each_user_type(): void
    {
        ...
        Assert::assertSame(UpdateUserHasherListener::class, $adminUserListenerDefinition->getClass());
        ...
        Assert::assertSame(UpdateUserHasherListener::class, $shopUserListenerDefinition->getClass());
