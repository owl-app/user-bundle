...
final class Configuration implements ConfigurationInterface
{
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->scalarNode('hasher')->defaultNull()->end()
            ->end()
        ;

        $this->addResourcesSection($rootNode);
        $this->addPermissionProviderSection($rootNode);
    ...
    private function addPermissionProviderSection(ArrayNodeDefinition $node): void
    {
        $node
            ->children()
                ->arrayNode('permission_provider')
                    ->prototype('scalar')
                    ->end()
                ->end()
            ->end();
